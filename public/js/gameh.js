...
$(document).ready(function () {
	...
	$("#next7").on("click", function () {
		handleQuestionSelection("Endings");
	});
	...
	function endGame() {
		alert("end game");
		function handleQuestionSelection(gameendings) {			
			//show/hide the correct questions 
			
		$("#end_container").show();
		if (power >= knowlege || power >= sanity){
		$("#endings1").show();
		$("#endings2").hide();
		$("#endings3").hide();
		$("#endings4").hide();
		...
		else if (sanity >= power || sanity >=knowlege){
		$("#endings1").hide();
		$("#endings2").hide();
		$("#endings3").show();
		$("#endings4").hide();
	}
		else if(knowlege >= power || knowlege >= power){
		$("#endings1").hide();
		$("#endings2").hide();
		$("#endings3").hide();
		$("#endings4").show();
		}
		else (power = sanity = knowlege)
		$("#endings1").hide();
		$("#endings2").show();
		$("#endings3").hide();
		$("#endings4").hide();
